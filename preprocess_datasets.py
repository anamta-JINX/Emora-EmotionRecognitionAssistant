...
# -----------------------------
FER_PATH  = os.path.join("Datasets", "fer", "fer2013.csv")
CK_ROOT   = os.path.join("Datasets", "ck")
RAF_ROOT  = os.path.join("Datasets", "rafdb")  # contains: DATASET/train/1..7 and DATASET/test/1..7
