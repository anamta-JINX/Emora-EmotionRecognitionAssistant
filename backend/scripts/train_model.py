...
from backend.app.config import BASE_MODEL_PATH, PREPROCESSED_DIR
...
data = np.load(PREPROCESSED_DIR / "images_labels.npz")
X = data["X"]
y = data["y"]
...
checkpoint = ModelCheckpoint(
    str(BASE_MODEL_PATH),          # overwrite best model here
...
print("\n✅ Training complete.")
print(f"✅ Best model saved as: {BASE_MODEL_PATH}")
