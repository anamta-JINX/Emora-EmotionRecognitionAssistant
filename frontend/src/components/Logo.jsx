  ...
  return (
    <Link to="/" className="group flex items-center gap-3" aria-label="EMORA home">
      ...
      <span className="leading-none">
        <span className={`block font-display text-lg font-extrabold tracking-[-0.04em] ${light ? 'text-white' : 'text-ink'}`}>
          EMORA
        </span>

        <span className={`mt-1 block text-[9px] font-bold uppercase tracking-[0.2em] ${light ? 'text-moss-200' : 'text-moss-600'}`}>
          Emotion assistant
        </span>
      </span>
    </Link>
